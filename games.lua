...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
database:del(bot_id..'Sra:Tr'..msg.chat_id_)
AlaSra = {'الاسطوره','قرنبيط','اليمن','طماطم','السعوديه','مكه','سلحفاه','روسيا','مصر','سوريا','سلام عليكم','ضفدع','فيلسووف','مهايطي','','خنفشار','سفينه','القسطنطينيه','سورس','مع نفسك','باسكال'};
name = AlaSra[math.random(#AlaSra)]
database:set(bot_id..'Ala:Sra'..msg.chat_id_,name)
...
name = string.gsub(name,'مكه','مكه')
name = string.gsub(name,'سلحفاه','سلحفاه')
name = string.gsub(name,'روسيا','روسيا')
name = string.gsub(name,'مصر','مصر')
name = string.gsub(name,'سوريا','سوريا')
name = string.gsub(name,'سلام عليكم','سلام عليكم')
name = string.gsub(name,'ضفدع','ضفدع')
name = string.gsub(name,'فيلسووف','فيلسووف')
name = string.gsub(name,'مهايطي','مهايطي')
name = string.gsub(name,'مع نفسك','مع نفسك')
name = string.gsub(name,'باسكال','باسكال')
name = string.gsub(name,'خنفشار','خنفشار')
name = string.gsub(name,'سورس','سورس')
name = string.gsub(name,'القسطنطينيه','القسطنطينيه')
name = string.gsub(name,'سفينه','سفينه')
send(msg.chat_id_, msg.id_,'🎗️| اسرع واحـد يرسل الـكـلـمـه » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..'Ala:Sra'..msg.chat_id_) or '')..'' and not database:get(bot_id..'Sra:Tr'..msg.chat_id_) then
if not database:get(bot_id..'Sra:Tr'..msg.chat_id_) then 
...
name = string.gsub(name,'193‪9','متى وقعت الحرب العالمية الثانية؟')
