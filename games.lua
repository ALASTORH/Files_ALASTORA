...
KlamSpeed = {'سحور','سياره','استقبال','مصر','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','قهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','الامارات','سوريا','كهرباء','تفاحه','اخطبوط','سلمون',' فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','اليمن','السعوديه','لبنان','جسر'};
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
mthal = {'طبيب','ضراطه','الحبل','الحافي','شقره','بيدك','سلايه','نخله','الخيل','الصقر','المبلل','يرقص','القرد','الدله','يعرفك','زيد','اقرد','مقصه','العنب','اليد','الخبز','بالحصاد','شهر','شكى','يكحلها',};
name = mthal[math.random(#mthal)]
database:set(bot_id..'Set:Amth'..msg.chat_id_,name)
database:del(bot_id..'Set:Amth:Bot'..msg.chat_id_)
name = string.gsub(name,'سلايه','بالوجه امراية وبالظهر___')
name = string.gsub(name,'الخيل','من قلة___شدو على الكلاب سروج')
name = string.gsub(name,'الصقر','اللي ما يعرف ____- يشويه')
name = string.gsub(name,'المبلل','___ما يخاف من المطر')
name = string.gsub(name,'الحبل','اللي تلدغة الحية يخاف من جرة___')
name = string.gsub(name,'يرقص','المايعرف___يقول القاع عوجه')
name = string.gsub(name,'العنب','اللي ما يطول____ حامضاً عنه يقول')
name = string.gsub(name,'الدله','أقلب ____ على فمها تطلع البنت لأمها')
name = string.gsub(name,'الخبز','اعطي___للخباز حتى لو ياكل نصه')
name = string.gsub(name,'بالحصاد','اسمة___ومنجله مكسور')
name = string.gsub(name,'شهر','امشي__ولا تعبر نهر')
name = string.gsub(name,'شكى','يامن تعب يامن__يا من على الحاضر لقى')
name = string.gsub(name,'القرد','__بعين امه غزال')
name = string.gsub(name,'يكحلها','اجه___عماها')
name = string.gsub(name,'مقصه','كل شارب وله ___')
name = string.gsub(name,'يعرفك','اللي ما _____ ما يثمنك')
name = string.gsub(name,'زيد','كأنك يا بو _____ ما غزيت')
name = string.gsub(name,'اقرد','أرضي بقردك لا يجيك ______ منه')
name = string.gsub(name,'اليد','العين بصيره و_____ قصيره.')
