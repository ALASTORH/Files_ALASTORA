...
name = string.gsub(name,'الاسطوره')
name = string.gsub(name,'دجاجه')
name = string.gsub(name,'بطريق')
name = string.gsub(name,'ضفدع')
name = string.gsub(name,'خنفشار')
name = string.gsub(name,'قرنبيط')
name = string.gsub(name,'القسطنطينيه')
...
name = string.gsub(name,'سورس الاسطوره')
name = string.gsub(name,'البحرين')
name = string.gsub(name,'مع نفسك')
name = string.gsub(name,'زرافه')
name = string.gsub(name,'قنفذ')
name = string.gsub(name,'سورس')
name = string.gsub(name,'باذنجان')
send(msg.chat_id_, msg.id_,'🎗️| اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
